...
class OrderCrudController extends AbstractCrudController
{
    ...
    public function updatePreparation(AdminContext $context)
    {
        ...
        <strong>La commande ".$order->getReference()."est bien en cours de préparation</u>.</strong></span>");
    ...
    public function updateDelivery(AdminContext $context)
    {
        ...
        $this->addFlash('notice', "<span style='color: orange'>
        <strong>La commande ".$order->getReference()."est bien en cours de Livraison</u>.</strong></span>");
